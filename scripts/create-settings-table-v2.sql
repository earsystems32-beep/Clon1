-- Create settings table for persistent configuration (Version 2)
-- Table: settings
...
CREATE TABLE IF NOT EXISTS settings (
  ...
  bonus_percentage INTEGER NOT NULL DEFAULT 25,
  bonus_enabled BOOLEAN NOT NULL DEFAULT true,
  updated_at TIMESTAMP WITH TIME ZONE DEFAULT NOW()
);

-- Insert default row if it doesn't exist
INSERT INTO settings (id, min_amount, timer_seconds, create_user_enabled, alias, phone, payment_type, bonus_percentage, bonus_enabled)
VALUES (1, 2000, 30, true, 'DLHogar.mp', '543415481923', 'alias', 25, true)
